...
import { UpdatePicPromptResult } from '../common/modals/update-pic-modal-form/update-pic-modal-form.component';
...
import { RobbotPromptResult } from '../common/modals/robbot-modal-form/robbot-modal-form.component';
import { createNewRobbot, validateCommonRobbotData, validateCommonRobbotIbGib } from '../common/helper/robbot';
import { AppPromptResult } from '../common/modals/app-modal-form/app-modal-form.component';
...
import { UpdateCommentPromptResult } from '../common/modals/update-comment-modal-form/update-comment-modal-form.component';
...
export class IbgibsService implements IbGibLocalSpaceService_AllPowerful {
  ...
  private fnPromptUpdatePic: (space: IbGibSpaceAny, picIbGib: PicIbGib_V1) => Promise<UpdatePicPromptResult | undefined>;
  private fnPromptUpdateComment: (space: IbGibSpaceAny, commentIbGib: CommentIbGib_V1) => Promise<UpdateCommentPromptResult | undefined>;
  fnPromptRobbot: (space: IbGibSpaceAny, ibGib: RobbotIbGib_V1) => Promise<RobbotPromptResult | undefined>;
  fnPromptApp: (space: IbGibSpaceAny, ibGib: AppIbGib_V1) => Promise<AppPromptResult | undefined>;

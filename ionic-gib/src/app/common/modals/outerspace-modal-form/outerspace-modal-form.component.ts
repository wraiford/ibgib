...
export class OuterspaceModalFormComponent
  ...
  fields: { [name: string]: FormItemInfo } = {
    ...
    primaryKeyName: {
      ...
      defaultErrorMsg: `Invalid primary key name. Right now, this must be IbGibAddrHash`,
    ...
    encryption: {
      ...
      label: "Encryption",
      defaultErrorMsg: `An Encryption is required.`,
    },
    selectedSecrets: {
      ...
      label: "Secrets",
      defaultErrorMsg: `At least one secret is required.`,
      private: true,
    },
  }
